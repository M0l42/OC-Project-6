...
CREATE TABLE public.Purchase (
                ...
                Paid_Price NUMERIC(9,2) NOT NULL,
                Restaurant_id INTEGER NOT NULL,
                Person_id INTEGER NOT NULL,
                Adress_id INTEGER NOT NULL,
...
CREATE TABLE public.Order_Aliment (
                id INTEGER NOT NULL,
                Purchase_id INTEGER NOT NULL,
                Aliment_id INTEGER NOT NULL,
                CONSTRAINT order_aliment_pk PRIMARY KEY (id)
);
...
ALTER TABLE public.Order_Aliment ADD CONSTRAINT aliment_order_aliment_fk
FOREIGN KEY (Aliment_id)
REFERENCES public.Aliment (id)
ON DELETE NO ACTION
ON UPDATE NO ACTION
...
ALTER TABLE public.Order_Aliment ADD CONSTRAINT order_order_aliment_fk
